...
Status: the numbered set is the design baseline; `37-harness-core.md` describes the harness as built, and the CLI now ships as a tagged release.
...
| Core runtime | [04](04-system-architecture.md), [05](05-rust-workspace.md), [06](06-agent-runtime.md), [07](07-context-engine.md), [08](08-prompt-compiler.md), [09](09-model-provider-layer.md), [10](10-tool-capability-system.md), [37](37-harness-core.md) |
